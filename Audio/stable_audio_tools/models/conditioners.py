    ...
    def __init__(
        ...
        with warnings.catch_warnings():
            ...
            try:
                ...
                self.tokenizer = AutoTokenizer.from_pretrained(t5_base_path)
                model = T5EncoderModel.from_pretrained(t5_base_path).train(enable_grad).requires_grad_(enable_grad).to(torch.float16)
