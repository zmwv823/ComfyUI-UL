...
def load_vad_model(device, vad_onset=0.500, vad_offset=0.363, use_auth_token=None, model_fp=None):
    ...
    if model_fp is None:
        ...
        # 加载本地comfyui模型路径下的vad模型。
        model_fp = os.path.join(os.path.dirname(current_directory), "whisperX_models\whisperx-vad-segmentation.bin")
