...
class UL_Data_Process_Create_SavedModel:
    @classmethod
    def INPUT_TYPES(cls):
    ...
    TITLE = "UL Data Process Create SavedModel"

    def UL_Data_Process_Create_SavedModel(self, translator_local_path, translator_path_or_repo_id, save_model_to_folder):
...
class UL_Load_Data:
    ...
    def UL_Load_Data(self, data):
        srt_path = folder_paths.get_annotated_filepath(data)
        return (srt_path,)

# Node class and display name mappings
NODE_CLASS_MAPPINGS = {
    "UL_Data_Process_Create_SavedModel": UL_Data_Process_Create_SavedModel, 
